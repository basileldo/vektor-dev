        ...
        <div class="container:lg">
            <article class="article article--overflow container:xl:1t2e edgeless:1t2e">
                ...
                <div class="metadata__collection">
                    <div class="metadata__item">David Dawes</div>
                    <div class="metadata__item">3<sup>rd</sup> April 2023</div>
                </div>
                ...
                <img src="/assets/img/article__image.jpg" alt="Bird's-eye view island" width="650" height="433" class="alignleft edgeless:1t2e w-full:1t2e" />
