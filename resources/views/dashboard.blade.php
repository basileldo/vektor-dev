                    ...
                    <template v-slot:fields="form">
                        <div class="mb-6">
                            ...
                            <div class="grid:3 grid-cols-2:3 gap-x-4:3">
                                ...
                                <c-input name="password" type="password" label="Existing Password" placeholder="Enter a password" v-model="form.field_values.password" :validationrule="form.validation_rules.password" :validationmsg="form.validation_messages.password"></c-input>
                            </div>
                        </div>
                        <div class="mb-6">
                            <div class="mb-4">
                        ...
                        <button type="submit" class="btn bg-secondary border-secondary text-secondary_contrasting" :class="{ is_disabled: form.validation_rules.$invalid == true }">Save my details</button>
                    </template>
                </c-form>
            </c-panel_expand>
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-6">
                        <div class="metadata__collection">
                            <div class="metadata__item" v-if="dashboard.panels.personal_details.phone">
                                <p><strong>Phone:</strong> <a :href="'tel:' + dashboard.panels.personal_details.tel">@{{ dashboard.panels.personal_details.phone }}</a></p>
                            </div>
                            <div class="metadata__item" v-if="dashboard.panels.personal_details.email">
