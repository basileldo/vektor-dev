...
@section('content')
    <div class="py-4 py-8:2 py-12:3">
        <div class="container:md">
            ...
            <c-form :name="forms.contact.ref" :ref="forms.contact.ref" method="post" :action="forms.contact.action" :field_values="forms.contact.field_values" :field_storage="forms.contact.field_storage" :field_validation_rules="forms.contact.validation_rules" :field_validation_messages="forms.contact.validation_messages"
            :clear_fields="true"
            >
                <template v-slot:fields="form">
                    ...
                    <div class="grid:3 grid-cols-2:3 gap-x-4:3 mb-6">
                        <div class="field__collection">
                            <c-input label="Newsletter Signup" name="newsletter" type="checkbox" valuelabel="Sign up to our newsletter?" v-model="form.field_values.newsletter" :validationrule="form.validation_rules.newsletter" :validationmsg="form.validation_messages.newsletter"></c-input>
                    ...
                    <button type="submit" class="btn bg-secondary border-secondary text-secondary_contrasting" :class="{ is_disabled: form.validation_rules.$invalid == true }">Submit my details</button>
                </template>
            </c-form>
        </div>
    </div>
