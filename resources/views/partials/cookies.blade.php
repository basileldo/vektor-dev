        ...
        <template v-slot:default="cookieTabs">
            <c-tab name="consent" label="Consent">
                ...
                <div class="action flex">
                    <a href="#" @click.stop.prevent="cookieScope.allCookies(false)" class="btn w-1/2 mr-2 border-primary text-black text-xs">Deny</a>
                    <a href="#" @click.stop.prevent="cookieScope.setActiveTab('customise')" class="btn w-1/2 ml-2 bg-primary border-primary text-primary_contrasting text-xs">Customise</a>
                    <a href="#" @click.stop.prevent="cookieScope.allCookies(true)" class="btn w-1/2 ml-2 bg-primary border-primary text-primary_contrasting text-xs">Accept All</a>
                </div>
            </c-tab>
            <c-tab name="customise" label="Details">
                ...
                <div class="action flex">
                    <a href="#" @click.stop.prevent="cookieScope.allCookies(false)" class="btn w-1/2 mr-2 border-primary text-black text-xs">Deny</a>
                    <a href="#" @click.stop.prevent="cookieScope.updateCookies()" class="btn w-1/2 ml-2 bg-primary border-primary text-primary_contrasting text-xs">Allow Selection</a>
                    <a href="#" @click.stop.prevent="cookieScope.allCookies(true)" class="btn w-1/2 ml-2 bg-primary border-primary text-primary_contrasting text-xs">Accept All</a>
                </div>
            </c-tab>
