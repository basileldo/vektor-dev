    ...
    <div class="py-4 py-8:2 py-12:3">
        <div class="container:md">
            <article class="article article--overflow container:xl:1t2e edgeless:1t2e">
                ...
                <p>At <strong>{{ config('app.company.name') }}</strong>, we understand the importance of your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and share your information when you visit our website or use our services.</p>
                ...
                <ul class="pl-6 list-outside list-decimal">
                    ...
                    <li><strong>We/Us/Our:</strong> Refers to {{ config('app.company.name') }}.</li>
                </ul>

                <h2 class="h3">2. Information About Us</h2>
                <p>Our website, <a href="{{ route('base') }}">{{ route('base') }}</a>, is owned and operated by {{ config('app.company.name') }}.</p>
                ...
                <p>If you have any questions or concerns regarding this Privacy Policy or our data practices, please contact us at <a href="mailto:{{ config('app.company.email') }}">{{ config('app.company.email') }}</a>.</p>
