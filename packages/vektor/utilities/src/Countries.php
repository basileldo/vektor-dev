...
class Countries
{
    ...
    {
        $allowed_countries = ! empty(config('utilities.allowed_countries')) ? explode(',', config('utilities.allowed_countries')) : null;
        $allowed_countries_property = config('utilities.allowed_countries_property');

        $_countries = [
            ['name' => 'Afghanistan', 'iso2' => 'AF', 'iso3' => 'AFG'],
            ['name' => 'Aland Islands', 'iso2' => 'AX', 'iso3' => 'ALA'],
            ['name' => 'Albania', 'iso2' => 'AL', 'iso3' => 'ALB'],
            ['name' => 'Algeria', 'iso2' => 'DZ', 'iso3' => 'DZA'],
            ['name' => 'American Samoa', 'iso2' => 'AS', 'iso3' => 'ASM'],
            ...
            ['name' => 'Bermuda', 'iso2' => 'BM', 'iso3' => 'BMU'],
            ['name' => 'Bhutan', 'iso2' => 'BT', 'iso3' => 'BTN'],
            ['name' => 'Bolivia', 'iso2' => 'BO', 'iso3' => 'BOL'],
            ['name' => 'Bonaire, Saint Eustatius and Saba ', 'iso2' => 'BQ', 'iso3' => 'BES'],
            ...
            ['name' => 'British Indian Ocean Territory', 'iso2' => 'IO', 'iso3' => 'IOT'],
            ['name' => 'British Virgin Islands', 'iso2' => 'VG', 'iso3' => 'VGB'],
            ...
            ['name' => 'Cayman Islands', 'iso2' => 'KY', 'iso3' => 'CYM'],
            ...
            ['name' => 'Falkland Islands', 'iso2' => 'FK', 'iso3' => 'FLK'],
            ['name' => 'Faroe Islands', 'iso2' => 'FO', 'iso3' => 'FRO'],
            ['name' => 'Fiji', 'iso2' => 'FJ', 'iso3' => 'FJI'],
            ['name' => 'Finland', 'iso2' => 'FI', 'iso3' => 'FIN'],
            ['name' => 'France', 'iso2' => 'FR', 'iso3' => 'FRA'],
            ['name' => 'French Guiana', 'iso2' => 'GF', 'iso3' => 'GUF'],
            ['name' => 'French Polynesia', 'iso2' => 'PF', 'iso3' => 'PYF'],
            ['name' => 'French Southern Territories', 'iso2' => 'TF', 'iso3' => 'ATF'],
            ...
            ['name' => 'Guadeloupe', 'iso2' => 'GP', 'iso3' => 'GLP'],
            ...
            ['name' => 'Martinique', 'iso2' => 'MQ', 'iso3' => 'MTQ'],
            ...
            ['name' => 'New Caledonia', 'iso2' => 'NC', 'iso3' => 'NCL'],
            ...
            ['name' => 'Reunion', 'iso2' => 'RE', 'iso3' => 'REU'],
            ['name' => 'Romania', 'iso2' => 'RO', 'iso3' => 'ROU'],
            ['name' => 'Russia', 'iso2' => 'RU', 'iso3' => 'RUS'],
            ['name' => 'Rwanda', 'iso2' => 'RW', 'iso3' => 'RWA'],
            ['name' => 'Saint Barthelemy', 'iso2' => 'BL', 'iso3' => 'BLM'],
            ['name' => 'Saint Helena', 'iso2' => 'SH', 'iso3' => 'SHN'],
            ['name' => 'Saint Kitts and Nevis', 'iso2' => 'KN', 'iso3' => 'KNA'],
            ['name' => 'Saint Lucia', 'iso2' => 'LC', 'iso3' => 'LCA'],
            ['name' => 'Saint Martin', 'iso2' => 'MF', 'iso3' => 'MAF'],
            ['name' => 'Saint Pierre and Miquelon', 'iso2' => 'PM', 'iso3' => 'SPM'],
            ...
            ['name' => 'Sint Maarten', 'iso2' => 'SX', 'iso3' => 'SXM'],
            ...
            ['name' => 'South Georgia and the South Sandwich Islands', 'iso2' => 'GS', 'iso3' => 'SGS'],
            ...
            ['name' => 'Svalbard and Jan Mayen', 'iso2' => 'SJ', 'iso3' => 'SJM'],
            ['name' => 'Swaziland', 'iso2' => 'SZ', 'iso3' => 'SWZ'],
            ...
            ['name' => 'Turks and Caicos Islands', 'iso2' => 'TC', 'iso3' => 'TCA'],
            ['name' => 'Tuvalu', 'iso2' => 'TV', 'iso3' => 'TUV'],
            ['name' => 'U.S. Virgin Islands', 'iso2' => 'VI', 'iso3' => 'VIR'],
            ...
            ['name' => 'United States Minor Outlying Islands', 'iso2' => 'UM', 'iso3' => 'UMI'],
            ...
            ['name' => 'Wallis and Futuna', 'iso2' => 'WF', 'iso3' => 'WLF'],
        ...
        $countries = array_filter($_countries, function ($_country) use ($allowed_countries, $allowed_countries_property) {
            return ($allowed_countries != null) ? in_array($_country[$allowed_countries_property], $allowed_countries) : true;
        });

        self::$countries = $countries;
    }

    public static function select($text = 'name', $value = 'iso2')
    {
        self::populate();
        $options = [];
    ...
    public static function convert($value, $source = 'name', $destination = 'iso2')
    {
        self::populate();
        $output = null;

        $countries = array_filter(self::$countries, function ($country) use ($value, $source) {
            return isset($country[$source]) && (strtolower(trim($value)) == strtolower(trim($country[$source])));
        });

        if (! empty($countries)) {
            $country = current($countries);
            if (isset($country[$destination])) {
                $output = $country[$destination];
            }
        }
