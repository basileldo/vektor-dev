...
class Task extends Model
{
    ...
    private function generateTaskDueDate()
    {
        ...
        $conditions_for_tues = [
            'is_after_weds' => $day > 3,
            'is_after_2pm_weds' => $day === 3 && $hour >= 14,
            'is_before_9am_mon' => $day === 1 && $hour < 9,
        ];
     ...
     */
    public function getDateDueAttribute(string|null $value): string|null
    {
